                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('specialities.update', $speciality->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @else is-valid @enderror" id="name" name="name" value="{{ $speciality->name }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @else is-valid @enderror" id="description" name="description" rows="6">{{ $speciality->description }}</textarea>
